        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-brand-50 flex items-center justify-center
              text-[12px] font-semibold text-brand-800">
            JS
          </button>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-stone-200 p-4">
          ...
          <ResponsiveContainer width="100%" height={90}>
            <AreaChart data={evolucao} margin={{ top: 4, right: 0, left: 0, bottom: 0 }}>
              ...
              <Tooltip
                contentStyle={{ fontSize: 11, borderRadius: 8, border: '0.5px solid #E8E6E0' }}
                formatter={(v: number) => [fmt(v), '']}
              />
              <Area
                type="monotone" dataKey="investido" stroke="#D3D1C7"
                strokeWidth={1} strokeDasharray="4 3" fill="none" dot={false}
              />
              <Area
                type="monotone" dataKey="atual" stroke="#1D9E75"
                strokeWidth={2} fill="url(#gradAtual)" dot={false}
              />
            </AreaChart>
          </ResponsiveContainer>
          ...
          <div className="flex gap-4 mt-2">
            <div className="flex items-center gap-1.5 text-[11px] text-stone-500">
              <div className="w-3 h-[2px] bg-brand-400 rounded" />Valor atual
            </div>
            <div className="flex items-center gap-1.5 text-[11px] text-stone-500">
              <div className="w-3 h-[2px] bg-stone-300 rounded border-dashed" />Investido
            </div>
          </div>
        </div>
