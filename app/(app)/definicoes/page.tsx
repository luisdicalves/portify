  ...
  return (
    <div className="flex items-center gap-3 py-3 border-b border-stone-100 last:border-0">
      ...
      {toggle !== undefined && onToggle
        ...
        : value
          ? <><span className="text-[13px] text-stone-400">{value}</span>
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="px-4 pt-4 space-y-3 pb-8">
        ...
        {/* Perigo */}
        <div className="bg-white rounded-2xl border border-stone-200 p-4">
          <button className="w-full flex items-center gap-3 py-3 border-b border-stone-100">
            <LogOut size={18} strokeWidth={1.75} color="#D85A30" />
            <span className="text-[14px] text-red-500 font-medium flex-1 text-left">Terminar sessão</span>
          </button>
